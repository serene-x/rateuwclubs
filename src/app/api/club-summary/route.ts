...
export async function POST(req: Request) {
  try {
    ...
    const inputText = `Summarize this University of Waterloo club in 1-2 sentences based on the description. If no description, use the name and tags. Stay under 150 characters. No links, emojis, or quotes.
